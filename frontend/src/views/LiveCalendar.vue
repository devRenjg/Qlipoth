...
<style scoped>
.lc { max-width: 1200px; margin: 0 auto; padding: 16px 20px 40px; }
...
.weekday { text-align: center; font-size: 12px; color: #8a96a8; padding: 4px 0; font-weight: 600; }
.day-cell { min-height: 96px; border: 1px solid #e3e8f0; border-radius: 8px; padding: 4px 6px; background: #fff; display: flex; flex-direction: column; }
.cal-grid.week .day-cell { min-height: 320px; }
...
.day-num { font-size: 12px; color: #909399; margin-bottom: 3px; }
.day-cell.is-today .day-num { color: #2f6bd6; font-weight: 700; }
.sess-list { display: flex; flex-direction: column; gap: 3px; overflow: auto; }
.sess { cursor: pointer; border-radius: 5px; padding: 3px 5px; font-size: 11px; border-left: 3px solid #c0c4cc; background: #f4f6fa; }
