...
| 版本号 | 日期 | 变更内容 | 作者 |
|--------|------|----------|------|
| 20260609.1 | 2026-06-09 | 保障清单升级(维度7→6撤"可复用沉淀"、新增"事故/故障"置顶+全库82篇打标、P0/P1/P2严重度分级、全文档扫描+跨活动借鉴去重限额、来源改可点击原始链接)；S赛清单基于翻倍文档重生成(225条)；smartsheet新版解析器(tab定位真表+k30结构解析)；上传自动打标统一为10主题+事故一次判定、活动标签传递给子文档 | Claude + User |
